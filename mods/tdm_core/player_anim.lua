tdm_core.anim = {}
tdm_core.anim.players = {} -- track current animation state: "stand", "walk", "mine"
...
core.register_globalstep(function(dtime)
    for _, player in ipairs(core.get_connected_players()) do
        ...
        local current_anim = tdm_core.anim.players[p_name]
        
        if current_anim ~= new_anim then
            tdm_core.anim.players[p_name] = new_anim
...
core.register_on_leaveplayer(function(player)
    tdm_core.anim.players[player:get_player_name()] = nil
end)
